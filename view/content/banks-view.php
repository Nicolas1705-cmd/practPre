  ...
  <div class="tabs ">
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-default">
                  ...
                  <div id="recent" class="tab-pane  ">
                             <div class="col-md-12">
             <form class="formAjax" action="<?php echo SERVERURL; ?>ajax/banksAjax.php" method="POST" data-form="save" data-ajax="banksAjax" data-urlhttp="<?php echo SERVERURL; ?>" <?php echo $multipart ?>  autocomplete="off" >
