<?php 
          require_once "./controller/CommunicationController.php";
          $inst= new CommunicationController();  
          $titulo = "Communication"; 
$ajaxGlobal="communicationAjax";   
  ...
  <div class="tabs ">
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-default">
                  ...
                  <div id="recent" class="tab-pane  ">
                             <div class="col-md-12">
             <form class="formAjax" action="<?php echo SERVERURL; ?>ajax/communicationAjax.php" method="POST" data-form="save" data-ajax="communicationlAjax" data-urlhttp="<?php echo SERVERURL; ?>" <?php echo $multipart ?>  autocomplete="off" >
