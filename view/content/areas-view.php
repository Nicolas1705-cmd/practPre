<?php 
          require_once "./controller/AreasController.php";
          $inst= new AreasController();  
          $titulo = "Areas"; 
$ajaxGlobal="areasAjax";   
  ...
  <div class="tabs ">
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-default">
                  ...
                  <div id="recent" class="tab-pane  ">
                             <div class="col-md-12">
             <form class="formAjax" action="<?php echo SERVERURL; ?>ajax/areasAjax.php" method="POST" data-form="save" data-ajax="areasAjax" data-urlhttp="<?php echo SERVERURL; ?>" <?php echo $multipart ?>  autocomplete="off" >
