        ...
        <div class="tabs">
            ...
            <div class="tab-content">
                ...
                <div id="recent" class="tab-pane">
                    <div class="col-md-12">
                        <form class="formAjax" action="<?php echo SERVERURL; ?>ajax/combustibleAjax.php" method="POST" data-form="save" data-ajax="combustibleAjax" data-urlhttp="<?php echo SERVERURL; ?>" <?php echo isset($multipart) ? $multipart : ''; ?> autocomplete="off">
